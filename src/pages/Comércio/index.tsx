        ...
        <Container>
          <Row className="row-cols-1 row-cols-lg-2 d-flex mt-5">
            <Col>
              ...
              <div className="mb-4 mb-md-5">
                ...
                <div className="d-flex flex-column fs-md mb-3">
                  ...
                  {market?.site && (
                    <div className="d-flex align-items-center mb-3">
                      ...
                      <a href={market.site} target="_blank" rel="noreferrer">
                        {market.site}
                      </a>
                    </div>
                  )}
                ...
                <div className="d-flex fs-md mb-3">
                  ...
                  <div className="d-flex gap-5">
                    <div>
                      {market?.horario_funcionamento.map((openingHour) => (
                        <div>
              ...
              {market?.formas_pagamento && market.formas_pagamento.length > 0 && (
                <div className="mb-4 mb-md-5">
                ...
                {market?.addresses?.length && (
                  <div className="w-100" style={{ height: '300px' }}>
                    <GoogleMapReact
                      ...
                      defaultZoom={15}
                    >
                      {market?.addresses?.map(({ id: addrId, lat, lng }) => (
